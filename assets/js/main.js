...
// sr.reveal('.skill2', { delay: 300 })
// sr.reveal('.skill3', { delay: 300 })
...
sr.reveal('.service2', { delay: 400 })
sr.reveal('.service3', { delay: 500 })
...
/* 判断是否点击显示菜单按钮 */
if (navToggle) {
  //绑定点击事件 如果点击了菜单栏 为navMenu添加show-menu类名
...
/*===== 隐藏菜单栏 =====*/
/* 绑定点击事件 如果点击了关闭按钮 移除上一步添加的类名 实现菜单栏隐藏 */
if (navClose) {
...
// 通过forEach遍历navLink类下的节点元素 为每一个元素绑定点击事件 回调函数为linkAction
...
function toggleSkills() {
  // this为header 父节点为content
  let itemClass = this.parentNode.className
  // 排他思想 先遍历所有三个技能内容元素，将其隐藏，将点击的那个content进行展示
